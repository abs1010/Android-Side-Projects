package com.alansilva.imc

import DecimalTextWatcher
...
import com.alansilva.imc.extensions.format
...
class MainActivity : AppCompatActivity() {
    ...
    private fun setUpListeners() {
        ...
        etAltura.addTextChangedListener(DecimalTextWatcher(editText = etAltura))
