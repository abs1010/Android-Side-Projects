package com.alansilva.sensores
    ...
    fun doLoginFingerPrint() {
        ...
        when (biometricManager.canAuthenticate()) {
            ...
            BiometricManager.BIOMETRIC_ERROR_HW_UNAVAILABLE ->
                Toast.makeText(
                    this,
                    "Hardware de biometria nao disponivel", Toast.LENGTH_LONG
                ).show()
        ...
        val biometricPrompt =
            BiometricPrompt(this, executor, object : BiometricPrompt.AuthenticationCallback() {
                ...
                override fun onAuthenticationError(
                    ...
                    Toast.makeText(
                        applicationContext,
                        "Usuário sem permissão de acesso", Toast.LENGTH_SHORT
                    ).show()
                }
